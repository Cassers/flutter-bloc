...
class GeolocationCubit extends Cubit<GeolocationState> {
  ...
  final void Function((double latitude, double longitude) location)? onNewUserLocationCallback;
  ...
  Future<void> watchUserLocation() async {
    ...
    const locationSettings = LocationSettings(accuracy: LocationAccuracy.bestForNavigation, distanceFilter: 15);
